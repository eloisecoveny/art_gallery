...
exhibit1 = Exhibit.new({"title" => "Terribly Wrong", "subtitle" => "Diaries of a Liar", "opening" => "19-02-2019", "closing" => "31-03-2019", "description" => "Emin's monoprints have a diaristic aspect and frequently depict events from the past.", "artist_id" => artist1.id, "category" => "performance", "image" => "https://uploads1.wikiart.org/images/tracey-emin/everybodies-been-there-1997.jpg!Large.jpg"})
exhibit1.save()

exhibit2 = Exhibit.new({"title" => "You Are Not Alone", "subtitle" => "Would the Earth Exist Without the Sun?", "opening" => "01-03-2019", "closing" => "10-05-2019", "description" => "A sound installation by Philipsz entitled You are not alone (Would the Earth Exist Without the Sun?) is her first “invisible” sculpture in the Bródnowski Park.", "artist_id" => artist2.id, "category" => "sound installation", "image" => "https://mapmagazine.co.uk/assets/articles/_entry/61814.01_BARRADA_vdet13_0.jpg"})
exhibit2.save()
